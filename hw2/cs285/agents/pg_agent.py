...
class PGAgent(BaseAgent):
    ...
    def calculate_q_vals(self, rewards_list):
        ...
        if not self.reward_to_go:
            ...
            #for i in range(len(rewards_list)):
                #q = self._discounted_return(rewards_list[i])
                #q_values.append(q)
            ...
            if self.gae_lambda is not None:
                ...
                for i in reversed(range(batch_size)):
                    ...
                    ## HINT 2: self.gae_lambda is the lambda value in the
                        ## GAE formula
                        advantages[i] = rews[i] - self.gamma* values[i+1]* (1-terminals[i]) - values[i] + self.gamma* self.gae_lambda* advantages[i+1] * (1-terminals[i]) 
                ...
                #advantages = np.subtract(q_values, values)
    ...
    def _discounted_return(self, rewards):
        ...
        """
        T = len(rewards)
        list_of_discounted_returns = np.repeat(np.sum((self.gamma ** np.arange(0, T)) * rewards), T)
        
# =============================================================================
#         sum = 0
#         for i in range(len(rewards)):
#             sum += pow(self.gamma, i-1) * rewards[i]
# =============================================================================
            
        # TODO: create list_of_discounted_returns
        #list_of_discounted_returns = np.repeat(sum, len(rewards))
    ...
    def _discounted_cumsum(self, rewards):
        ...
        T = len(rewards)
        for i in range(T):
            list_of_discounted_cumsums = np.append(list_of_discounted_cumsums, np.dot(self.gamma ** np.arange(T-i) ,rewards[i:]))
        # TODO: create `list_of_discounted_returns`
