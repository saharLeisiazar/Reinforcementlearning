...
class RL_Trainer(object):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            if itr % self.params['video_log_freq'] == 0 and self.params['video_log_freq'] != -1 and itr > 250:
                self.logvideo = True
            else:
                self.logvideo = False
...
#             lr_value = '2e-2'
#             batch_value = '50000'
#             option = 'on_rtg_no_baseline'
#             extention = lr_value +','+ batch_value +','+ option
# =============================================================================
            ...
            if itr == n_iter-1:
                ...
                with open('/home/sahar/RL/homework_fall2021/hw2/results/8.5/' + extention, "wb") as fp:   
...
# =============================================================================
#                 plt.figure( )
#                 plt.errorbar(self.itr_list, self.Eval_AveRet, self.Eval_StdRet, linestyle='-', label= batch_value + ',' +lr_value , ecolor='lightgray') 
#                 plt.xlabel("Number of itteration")
#                 plt.ylabel("Mean Return (Reward)")
#                 plt.legend()
#                 plt.savefig('/home/sahar/RL/homework_fall2021/hw2/results/5.2.('+ batch_value + ',' +lr_value + ').png')
# =============================================================================
