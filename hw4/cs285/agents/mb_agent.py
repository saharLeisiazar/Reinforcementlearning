...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            data_random = np.random.permutation(num_data)[:num_data_per_ens]
            observations = ob_no[data_random ]# TODO(Q1)
            actions = ac_na[data_random]# TODO(Q1)
            next_observations = next_ob_no[data_random]# TODO(Q1)
