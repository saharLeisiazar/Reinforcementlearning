...
class RL_Trainer(object):
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample, save_expert_data_to_disk=False):
        ...
        if self.logvideo:
             ...
             train_video_paths = utils.sample_n_trajectories(self.env, collect_policy, MAX_NVIDEO, MAX_VIDEO_LEN, False)
    ...
    def perform_logging(self, itr, paths, eval_policy, train_video_paths, all_logs):
        ...
        if self.logvideo and train_video_paths != None:
            ...
            eval_video_paths = utils.sample_n_trajectories(self.env, eval_policy, MAX_NVIDEO, MAX_VIDEO_LEN, False)
    ...
    def log_model_predictions(self, itr, all_logs):
        ...
        save_loc = '/home/sahar/RL/homework_fall2021/hw4/results/' + self.params['exp_name'] 
        #self.fig.savefig(save_loc , dpi=200, bbox_inches='tight')
