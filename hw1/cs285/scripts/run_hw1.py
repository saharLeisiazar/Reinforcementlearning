...
def main():
    ...
    #parser.add_argument('--expert_policy_file', '-epf', type=str, default='/home/sahar/RL/homework_fall2021/hw1/cs285/policies/experts/Ant.pkl', required=True)  # relative to where you're running this script from
    
    parser.add_argument('--expert_data', '-ed', type=str, required=True) #relative to where you're running this script from
    #parser.add_argument('--expert_data', '-ed', type=str, default='Ant.pkl') #relative to where you're running this script from
